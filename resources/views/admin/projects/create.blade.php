                ...
                <div class="col-7 my-3">
                    <form action="{{route('admin.projects.store')}}" method="POST">
                        ...
                        <div class="input-group input-group-sm mb-3">
                            <label class="text-white input-group-text bg_blue me-3 border-0 bg_orange" for="title">Title</label>
                        ...
                        <button type="submit" class="text-white input-group-text bg_blue me-3 border-0 bg_orange">Invia</button>
                    </form>
                </div>
            </div>
